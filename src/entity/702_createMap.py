...
jas = ent.createJsonByJaDbpedia(terms, skip=True)

print("redirects")
rs = ent.redirects(terms, skip=True)
...
searchResult = ent.createJsonByGoogleSearch(terms, jas, skip=True)
